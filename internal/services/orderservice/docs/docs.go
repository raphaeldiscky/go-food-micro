...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raphaeldiscky_go-food-micro_internal_services_orderservice_internal_orders_features_getting_orders_v1_dtos.GetOrdersResponseDto"
                        }
                    }
                }
            },
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/github_com_raphaeldiscky_go-food-micro_internal_services_orderservice_internal_orders_features_creating_order_v1_dtos.CreateOrderRequestDto"
                        }
                    }
                ],
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/github_com_raphaeldiscky_go-food-micro_internal_services_orderservice_internal_orders_features_creating_order_v1_dtos.CreateOrderResponseDto"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github_com_raphaeldiscky_go-food-micro_internal_services_orderservice_internal_orders_features_creating_order_v1_dtos.CreateOrderRequestDto": {
            "type": "object",
            "properties": {
                "accountEmail": {
                    "type": "string"
        ...
        "github_com_raphaeldiscky_go-food-micro_internal_services_orderservice_internal_orders_features_getting_orders_v1_dtos.GetOrdersResponseDto": {
            "type": "object",
            "properties": {
                "orders": {
