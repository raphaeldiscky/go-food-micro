...
func (_m *ProductsServiceClient) CreateProduct(
	ctx context.Context,
	in *productsservice.CreateProductReq,
...
//   - opts ...grpc.CallOption
func (_e *ProductsServiceClient_Expecter) CreateProduct(
	ctx interface{},
	in interface{},
	opts ...interface{},
) *ProductsServiceClient_CreateProduct_Call {
...
func (_c *ProductsServiceClient_CreateProduct_Call) Run(
	run func(ctx context.Context, in *productsservice.CreateProductReq, opts ...grpc.CallOption),
) *ProductsServiceClient_CreateProduct_Call {
...
func (_c *ProductsServiceClient_CreateProduct_Call) Return(
	_a0 *productsservice.CreateProductRes,
	_a1 error,
) *ProductsServiceClient_CreateProduct_Call {
...
func (_c *ProductsServiceClient_CreateProduct_Call) RunAndReturn(
	run func(context.Context, *productsservice.CreateProductReq, ...grpc.CallOption) (*productsservice.CreateProductRes, error),
) *ProductsServiceClient_CreateProduct_Call {
	_c.Call.Return(run)
...
func (_m *ProductsServiceClient) GetProductByID(
	ctx context.Context,
	in *productsservice.GetProductByIDReq,
	opts ...grpc.CallOption,
...
//   - opts ...grpc.CallOption
func (_e *ProductsServiceClient_Expecter) GetProductByID(
	ctx interface{},
	in interface{},
	opts ...interface{},
) *ProductsServiceClient_GetProductById_Call {
	return &ProductsServiceClient_GetProductById_Call{Call: _e.mock.On("GetProductByID",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *ProductsServiceClient_GetProductById_Call) Run(
	run func(ctx context.Context, in *productsservice.GetProductByIDReq, opts ...grpc.CallOption),
) *ProductsServiceClient_GetProductById_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
		...
		run(
			...
			args[1].(*productsservice.GetProductByIDReq),
			variadicArgs...)
	})
...
func (_c *ProductsServiceClient_GetProductById_Call) Return(
	_a0 *productsservice.GetProductByIDRes,
	_a1 error,
) *ProductsServiceClient_GetProductById_Call {
	_c.Call.Return(_a0, _a1)
...
func (_c *ProductsServiceClient_GetProductById_Call) RunAndReturn(
	run func(context.Context, *productsservice.GetProductByIDReq, ...grpc.CallOption) (*productsservice.GetProductByIDRes, error),
) *ProductsServiceClient_GetProductById_Call {
	_c.Call.Return(run)
...
func (_m *ProductsServiceClient) UpdateProduct(
	ctx context.Context,
	in *productsservice.UpdateProductReq,
	opts ...grpc.CallOption,
...
//   - opts ...grpc.CallOption
func (_e *ProductsServiceClient_Expecter) UpdateProduct(
	ctx interface{},
	in interface{},
	opts ...interface{},
) *ProductsServiceClient_UpdateProduct_Call {
	return &ProductsServiceClient_UpdateProduct_Call{Call: _e.mock.On("UpdateProduct",
		append([]interface{}{ctx, in}, opts...)...)}
}

func (_c *ProductsServiceClient_UpdateProduct_Call) Run(
	run func(ctx context.Context, in *productsservice.UpdateProductReq, opts ...grpc.CallOption),
) *ProductsServiceClient_UpdateProduct_Call {
	_c.Call.Run(func(args mock.Arguments) {
		variadicArgs := make([]grpc.CallOption, len(args)-2)
		for i, a := range args[2:] {
...
func (_c *ProductsServiceClient_UpdateProduct_Call) Return(
	_a0 *productsservice.UpdateProductRes,
	_a1 error,
) *ProductsServiceClient_UpdateProduct_Call {
	_c.Call.Return(_a0, _a1)
...
func (_c *ProductsServiceClient_UpdateProduct_Call) RunAndReturn(
	run func(context.Context, *productsservice.UpdateProductReq, ...grpc.CallOption) (*productsservice.UpdateProductRes, error),
) *ProductsServiceClient_UpdateProduct_Call {
	_c.Call.Return(run)
