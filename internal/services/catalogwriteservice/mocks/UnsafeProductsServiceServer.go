...
func (_e *UnsafeProductsServiceServer_Expecter) mustEmbedUnimplementedProductsServiceServer() *UnsafeProductsServiceServer_mustEmbedUnimplementedProductsServiceServer_Call {
	return &UnsafeProductsServiceServer_mustEmbedUnimplementedProductsServiceServer_Call{
		Call: _e.mock.On("mustEmbedUnimplementedProductsServiceServer"),
	}
}

func (_c *UnsafeProductsServiceServer_mustEmbedUnimplementedProductsServiceServer_Call) Run(
	run func(),
) *UnsafeProductsServiceServer_mustEmbedUnimplementedProductsServiceServer_Call {
...
func (_c *UnsafeProductsServiceServer_mustEmbedUnimplementedProductsServiceServer_Call) RunAndReturn(
	run func(),
) *UnsafeProductsServiceServer_mustEmbedUnimplementedProductsServiceServer_Call {
	_c.Call.Return(run)
