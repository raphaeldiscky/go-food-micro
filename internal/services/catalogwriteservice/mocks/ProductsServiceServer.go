...
func (_m *ProductsServiceServer) CreateProduct(
	_a0 context.Context,
	_a1 *productsservice.CreateProductReq,
...
func (_e *ProductsServiceServer_Expecter) CreateProduct(
	_a0 interface{},
	_a1 interface{},
) *ProductsServiceServer_CreateProduct_Call {
	return &ProductsServiceServer_CreateProduct_Call{Call: _e.mock.On("CreateProduct", _a0, _a1)}
}

func (_c *ProductsServiceServer_CreateProduct_Call) Run(
	run func(_a0 context.Context, _a1 *productsservice.CreateProductReq),
) *ProductsServiceServer_CreateProduct_Call {
...
func (_c *ProductsServiceServer_CreateProduct_Call) Return(
...
func (_c *ProductsServiceServer_CreateProduct_Call) RunAndReturn(
	run func(context.Context, *productsservice.CreateProductReq) (*productsservice.CreateProductRes, error),
) *ProductsServiceServer_CreateProduct_Call {
	_c.Call.Return(run)
...
func (_m *ProductsServiceServer) GetProductByID(
	_a0 context.Context,
	_a1 *productsservice.GetProductByIDReq,
...
func (_e *ProductsServiceServer_Expecter) GetProductByID(
	_a0 interface{},
	_a1 interface{},
) *ProductsServiceServer_GetProductById_Call {
	return &ProductsServiceServer_GetProductById_Call{Call: _e.mock.On("GetProductByID", _a0, _a1)}
}

func (_c *ProductsServiceServer_GetProductById_Call) Run(
	run func(_a0 context.Context, _a1 *productsservice.GetProductByIDReq),
) *ProductsServiceServer_GetProductById_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProductsServiceServer_GetProductById_Call) Return(
...
func (_c *ProductsServiceServer_GetProductById_Call) RunAndReturn(
	run func(context.Context, *productsservice.GetProductByIDReq) (*productsservice.GetProductByIDRes, error),
) *ProductsServiceServer_GetProductById_Call {
	_c.Call.Return(run)
...
func (_m *ProductsServiceServer) UpdateProduct(
	_a0 context.Context,
	_a1 *productsservice.UpdateProductReq,
...
func (_e *ProductsServiceServer_Expecter) UpdateProduct(
	_a0 interface{},
	_a1 interface{},
) *ProductsServiceServer_UpdateProduct_Call {
	return &ProductsServiceServer_UpdateProduct_Call{Call: _e.mock.On("UpdateProduct", _a0, _a1)}
}

func (_c *ProductsServiceServer_UpdateProduct_Call) Run(
	run func(_a0 context.Context, _a1 *productsservice.UpdateProductReq),
) *ProductsServiceServer_UpdateProduct_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProductsServiceServer_UpdateProduct_Call) Return(
...
func (_c *ProductsServiceServer_UpdateProduct_Call) RunAndReturn(
	run func(context.Context, *productsservice.UpdateProductReq) (*productsservice.UpdateProductRes, error),
) *ProductsServiceServer_UpdateProduct_Call {
	_c.Call.Return(run)
