...
func (_m *ProductRepository) CreateProduct(
	ctx context.Context,
...
//   - ctx context.Context
//   - product *models.Product
func (_e *ProductRepository_Expecter) CreateProduct(
	ctx interface{},
	product interface{},
) *ProductRepository_CreateProduct_Call {
	return &ProductRepository_CreateProduct_Call{Call: _e.mock.On("CreateProduct", ctx, product)}
}

func (_c *ProductRepository_CreateProduct_Call) Run(
	run func(ctx context.Context, product *models.Product),
) *ProductRepository_CreateProduct_Call {
...
func (_c *ProductRepository_CreateProduct_Call) Return(
	_a0 *models.Product,
	_a1 error,
) *ProductRepository_CreateProduct_Call {
...
func (_c *ProductRepository_CreateProduct_Call) RunAndReturn(
	run func(context.Context, *models.Product) (*models.Product, error),
) *ProductRepository_CreateProduct_Call {
	_c.Call.Return(run)
...
//   - ctx context.Context
//   - _a1 uuid.UUID
func (_e *ProductRepository_Expecter) DeleteProductByID(
	ctx interface{},
	_a1 interface{},
) *ProductRepository_DeleteProductByID_Call {
	return &ProductRepository_DeleteProductByID_Call{
		Call: _e.mock.On("DeleteProductByID", ctx, _a1),
	}
}

func (_c *ProductRepository_DeleteProductByID_Call) Run(
	run func(ctx context.Context, _a1 uuid.UUID),
) *ProductRepository_DeleteProductByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProductRepository_DeleteProductByID_Call) Return(
	_a0 error,
) *ProductRepository_DeleteProductByID_Call {
	_c.Call.Return(_a0)
...
func (_c *ProductRepository_DeleteProductByID_Call) RunAndReturn(
...
func (_m *ProductRepository) GetAllProducts(
	ctx context.Context,
...
//   - ctx context.Context
//   - listQuery *utils.ListQuery
func (_e *ProductRepository_Expecter) GetAllProducts(
	ctx interface{},
	listQuery interface{},
) *ProductRepository_GetAllProducts_Call {
	return &ProductRepository_GetAllProducts_Call{
		Call: _e.mock.On("GetAllProducts", ctx, listQuery),
	}
}

func (_c *ProductRepository_GetAllProducts_Call) Run(
	run func(ctx context.Context, listQuery *utils.ListQuery),
) *ProductRepository_GetAllProducts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProductRepository_GetAllProducts_Call) Return(
	_a0 *utils.ListResult[*models.Product],
	_a1 error,
) *ProductRepository_GetAllProducts_Call {
	_c.Call.Return(_a0, _a1)
...
func (_c *ProductRepository_GetAllProducts_Call) RunAndReturn(
	run func(context.Context, *utils.ListQuery) (*utils.ListResult[*models.Product], error),
) *ProductRepository_GetAllProducts_Call {
	_c.Call.Return(run)
...
func (_m *ProductRepository) GetProductByID(
	ctx context.Context,
	_a1 uuid.UUID,
) (*models.Product, error) {
	ret := _m.Called(ctx, _a1)
...
//   - ctx context.Context
//   - _a1 uuid.UUID
func (_e *ProductRepository_Expecter) GetProductByID(
	ctx interface{},
	_a1 interface{},
) *ProductRepository_GetProductById_Call {
	return &ProductRepository_GetProductById_Call{Call: _e.mock.On("GetProductByID", ctx, _a1)}
}

func (_c *ProductRepository_GetProductById_Call) Run(
	run func(ctx context.Context, _a1 uuid.UUID),
) *ProductRepository_GetProductById_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(uuid.UUID))
...
func (_c *ProductRepository_GetProductById_Call) Return(
	_a0 *models.Product,
	_a1 error,
) *ProductRepository_GetProductById_Call {
	_c.Call.Return(_a0, _a1)
...
func (_c *ProductRepository_GetProductById_Call) RunAndReturn(
	run func(context.Context, uuid.UUID) (*models.Product, error),
) *ProductRepository_GetProductById_Call {
	_c.Call.Return(run)
...
func (_m *ProductRepository) SearchProducts(
	ctx context.Context,
	searchText string,
	listQuery *utils.ListQuery,
) (*utils.ListResult[*models.Product], error) {
...
//   - searchText string
//   - listQuery *utils.ListQuery
func (_e *ProductRepository_Expecter) SearchProducts(
	ctx interface{},
	searchText interface{},
	listQuery interface{},
) *ProductRepository_SearchProducts_Call {
	return &ProductRepository_SearchProducts_Call{
		Call: _e.mock.On("SearchProducts", ctx, searchText, listQuery),
	}
}

func (_c *ProductRepository_SearchProducts_Call) Run(
	run func(ctx context.Context, searchText string, listQuery *utils.ListQuery),
) *ProductRepository_SearchProducts_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProductRepository_SearchProducts_Call) Return(
	_a0 *utils.ListResult[*models.Product],
	_a1 error,
) *ProductRepository_SearchProducts_Call {
	_c.Call.Return(_a0, _a1)
...
func (_c *ProductRepository_SearchProducts_Call) RunAndReturn(
	run func(context.Context, string, *utils.ListQuery) (*utils.ListResult[*models.Product], error),
) *ProductRepository_SearchProducts_Call {
	_c.Call.Return(run)
...
func (_m *ProductRepository) UpdateProduct(
	ctx context.Context,
	product *models.Product,
) (*models.Product, error) {
	ret := _m.Called(ctx, product)
...
//   - ctx context.Context
//   - product *models.Product
func (_e *ProductRepository_Expecter) UpdateProduct(
	ctx interface{},
	product interface{},
) *ProductRepository_UpdateProduct_Call {
	return &ProductRepository_UpdateProduct_Call{Call: _e.mock.On("UpdateProduct", ctx, product)}
}

func (_c *ProductRepository_UpdateProduct_Call) Run(
	run func(ctx context.Context, product *models.Product),
) *ProductRepository_UpdateProduct_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(*models.Product))
...
func (_c *ProductRepository_UpdateProduct_Call) Return(
	_a0 *models.Product,
	_a1 error,
) *ProductRepository_UpdateProduct_Call {
	_c.Call.Return(_a0, _a1)
...
func (_c *ProductRepository_UpdateProduct_Call) RunAndReturn(
	run func(context.Context, *models.Product) (*models.Product, error),
) *ProductRepository_UpdateProduct_Call {
	_c.Call.Return(run)
