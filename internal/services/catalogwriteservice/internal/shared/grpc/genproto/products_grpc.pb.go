...
type ProductsServiceClient interface {
	...
	) (*CreateProductRes, error)
	UpdateProduct(
		ctx context.Context,
		in *UpdateProductReq,
		opts ...grpc.CallOption,
	) (*UpdateProductRes, error)
	GetProductByID(
		ctx context.Context,
		in *GetProductByIDReq,
		opts ...grpc.CallOption,
	) (*GetProductByIDRes, error)
}
...
func (c *productsServiceClient) CreateProduct(
	ctx context.Context,
	in *CreateProductReq,
	opts ...grpc.CallOption,
) (*CreateProductRes, error) {
...
func (c *productsServiceClient) UpdateProduct(
	ctx context.Context,
	in *UpdateProductReq,
	opts ...grpc.CallOption,
) (*UpdateProductRes, error) {
...
func (c *productsServiceClient) GetProductByID(
	ctx context.Context,
	in *GetProductByIDReq,
	opts ...grpc.CallOption,
) (*GetProductByIDRes, error) {
...
func (UnimplementedProductsServiceServer) CreateProduct(
	context.Context,
	*CreateProductReq,
) (*CreateProductRes, error) {
...
func (UnimplementedProductsServiceServer) UpdateProduct(
	context.Context,
	*UpdateProductReq,
) (*UpdateProductRes, error) {
...
func (UnimplementedProductsServiceServer) GetProductByID(
	context.Context,
	*GetProductByIDReq,
) (*GetProductByIDRes, error) {
...
func _ProductsService_CreateProduct_Handler(
	srv interface{},
	ctx context.Context,
...
func _ProductsService_UpdateProduct_Handler(
	srv interface{},
	ctx context.Context,
	dec func(interface{}) error,
	interceptor grpc.UnaryServerInterceptor,
...
func _ProductsService_GetProductByID_Handler(
	srv interface{},
	ctx context.Context,
	dec func(interface{}) error,
	interceptor grpc.UnaryServerInterceptor,
