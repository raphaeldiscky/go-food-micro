...
import (
	...
	models "github.com/raphaeldiscky/go-food-micro/internal/services/catalogreadservice/internal/products/models"
...
// DeleteProductByID provides a mock function with given fields: ctx, uuid
func (_m *ProductRepository) DeleteProductByID(ctx context.Context, uuid string) error {
...
//   - ctx context.Context
//   - uuid string
func (_e *ProductRepository_Expecter) DeleteProductByID(ctx interface{}, uuid interface{}) *ProductRepository_DeleteProductByID_Call {
	return &ProductRepository_DeleteProductByID_Call{Call: _e.mock.On("DeleteProductByID", ctx, uuid)}
}

func (_c *ProductRepository_DeleteProductByID_Call) Run(run func(ctx context.Context, uuid string)) *ProductRepository_DeleteProductByID_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *ProductRepository_DeleteProductByID_Call) RunAndReturn(run func(context.Context, string) error) *ProductRepository_DeleteProductByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *ProductRepository_GetProductByID_Call) RunAndReturn(run func(context.Context, string) (*models.Product, error)) *ProductRepository_GetProductByID_Call {
	_c.Call.Return(run)
	return _c
}

// GetProductByProductID provides a mock function with given fields: ctx, uuid
func (_m *ProductRepository) GetProductByProductID(ctx context.Context, uuid string) (*models.Product, error) {
	ret := _m.Called(ctx, uuid)
...
// ProductRepository_GetProductByProductID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetProductByProductID'
type ProductRepository_GetProductByProductID_Call struct {
	*mock.Call
}

// GetProductByProductID is a helper method to define mock.On call
//   - ctx context.Context
//   - uuid string
func (_e *ProductRepository_Expecter) GetProductByProductID(ctx interface{}, uuid interface{}) *ProductRepository_GetProductByProductID_Call {
	return &ProductRepository_GetProductByProductID_Call{Call: _e.mock.On("GetProductByProductID", ctx, uuid)}
}

func (_c *ProductRepository_GetProductByProductID_Call) Run(run func(ctx context.Context, uuid string)) *ProductRepository_GetProductByProductID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(string))
	})
	return _c
...
func (_c *ProductRepository_GetProductByProductID_Call) Return(_a0 *models.Product, _a1 error) *ProductRepository_GetProductByProductID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *ProductRepository_GetProductByProductID_Call) RunAndReturn(run func(context.Context, string) (*models.Product, error)) *ProductRepository_GetProductByProductID_Call {
	_c.Call.Return(run)
	return _c
}
