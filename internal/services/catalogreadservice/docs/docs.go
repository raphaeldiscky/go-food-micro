...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raphaeldiscky_go-food-micro_internal_services_catalogreadservice_internal_products_features_getting_products_v1_dtos.GetProductsResponseDto"
                        }
                    }
                }
            }
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/github_com_raphaeldiscky_go-food-micro_internal_services_catalogreadservice_internal_products_features_searching_products_v1_dtos.SearchProductsResponseDto"
                        }
                    }
                }
            }
    ...
    "definitions": {
        ...
        "github_com_raphaeldiscky_go-food-micro_internal_services_catalogreadservice_internal_products_features_getting_products_v1_dtos.GetProductsResponseDto": {
            "type": "object",
            "properties": {
                "products": {
        ...
        "github_com_raphaeldiscky_go-food-micro_internal_services_catalogreadservice_internal_products_features_searching_products_v1_dtos.SearchProductsResponseDto": {
            "type": "object",
            "properties": {
                "products": {
                    "$ref": "#/definitions/utils.ListResult-github_com_raphaeldiscky_go-food-micro_internal_services_catalogreadservice_internal_products_dto_ProductDto"
