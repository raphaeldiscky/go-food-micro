...
# goimports-reviser -company-prefixes "github.com/raphaeldiscky" -project-name "github.com/raphaeldiscky/go-food-micro" -rm-unused -set-alias -imports-order "std,general,company,project,blanked,dotted" -recursive ./...
